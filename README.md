# [**@omegion1npm/officia-nam-possimus**](https://github.com/omegion1npm/officia-nam-possimus)

[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)
![npm (scoped)](https://img.shields.io/npm/v/@omegion1npm/officia-nam-possimus)
![node-current (scoped)](https://img.shields.io/node/v/@omegion1npm/officia-nam-possimus)
[![Build Status](https://img.shields.io/github/actions/workflow/status/omegion1npm/officia-nam-possimus/git-build.yml?branch=master)](https://img.shields.io/github/actions/workflow/status/omegion1npm/officia-nam-possimus/git-build.yml?branch=master)
[![Coverage Status](https://coveralls.io/repos/github/omegion1npm/officia-nam-possimus/badge.svg?branch=master)](https://coveralls.io/github/omegion1npm/officia-nam-possimus?branch=master)
...
```js
const jt = require('@omegion1npm/officia-nam-possimus');
